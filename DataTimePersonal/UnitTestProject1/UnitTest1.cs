...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void AddYears_UpdatesYears()
        {
            ...
            date.AddYears(5);
            Assert.AreEqual(5, date.GetYears());
        }
        ...
        public void SubtractYears_UpdatesYears()
        {
            ...
            Assert.AreEqual(0, date.GetYears());
        }
        ...
        public void AddMonths_UpdatesMonths()
        {
            DataTimeLigic date = new DataTimeLigic();
            date.AddMonths(8);
            Assert.AreEqual(8, date.GetMonths());
        }
        ...
        public void GetDate_ReturnsDate()
        {
            ...
            Assert.AreEqual("2023 год 11 месяцев 1 день", result);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void SetDate_InvalidDate_ThrowsException()
        {
            DataTimeLigic date = new DataTimeLigic();
        ...
        public void MultiplyBy_MultipliesValues()
        {
            DataTimeLigic date = new DataTimeLigic();
            date.MultiplyBy(2);
            Assert.AreEqual(2, date.GetYears());
            Assert.AreEqual(0, date.GetMonths());
            Assert.AreEqual(0, date.GetDays());
            Assert.AreEqual(0, date.GetHours());
            Assert.AreEqual(0, date.GetMinutes());
            Assert.AreEqual(0, date.GetSeconds());
        }
        ...
        public void DivideBy_DividesValues()
        {
            ...
            Assert.AreEqual(4, date.GetMonths());
            Assert.AreEqual(5, date.GetDays());
            Assert.AreEqual(5, date.GetHours());
            Assert.AreEqual(5, date.GetMinutes());
            Assert.AreEqual(5, date.GetSeconds());
        }
        ...
        public void CompareDates_ReturnsDifference()
        {
            ...
            DataTimeLigic date2 = new DataTimeLigic(new DateTime(2023, 10, 15, 10, 30, 45));
            string result = date1.CompareDates(date2);
            Assert.AreEqual("0 год 0 месяцев 15 дней 6 часов 30 минут 45 секунд", result);
        }
    }
